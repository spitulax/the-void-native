...
<?php if ($user): ?>
    <?php button(
        ...
        'fixed bottom-16 right-10 rounded-xs bg-base border-2 border-accent hover:border-transparent hover:bg-accent-dark p-2 shadow-lg hover:scale-125 transition transform cursor-pointer',
    ); ?>
<?php endif; ?>
